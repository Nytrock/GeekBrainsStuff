...
public class Homework4Vol2 {
    ...
    public static class Cat extends Animal {
        ...
        public void eat(){
            if (appetit > Volume){
                System.out.println(name + " satiety = false;" + " еды осталось " + Volume + ", к следующей кормёжке она заполнится; миска принажлежит только ему, её размер " + razm);
                Volume = razm;
            }
            else {
                Volume -= appetit;
                System.out.println(name + " satiety = true;" + " еды осталось " + Volume  + "; миска принажлежит только ему, её размер " + razm);
            }
        }
        public void swim(int swim){
            System.out.print(name + " swim:false\n");
