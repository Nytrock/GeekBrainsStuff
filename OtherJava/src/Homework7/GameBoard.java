...
public class GameBoard extends JFrame {
    ...
    void updateGameField(int x, int y){
        gameField[y][x] = game.getCurrentPlayer().getPlayersSign();
    }

    boolean checkWin(){
        boolean result = false;

        char playersSymbol = getGame().getCurrentPlayer().getPlayersSign();

        if(checkWinDiagonals(playersSymbol) || checkWinLines(playersSymbol)){
            result = true;
        }
